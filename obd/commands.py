...
__mode1__ = [
    ...
    OBDCommand("ODOMETER"                   , "Vehicle odometer"                        , b"01A6", 6, odometer,              ECU.ALL,    True),
    OBDCommand("HV_BATTERY_SOC"             , "HV battery pack state of charge"         , b"015B", 3, percent,               ECU.ALL,    True),
